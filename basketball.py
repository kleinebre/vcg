...
1200 IF RND(1)>.782*D/8 THEN 1250
	...
	IF RND(1)<=.5 THEN PRINT O$;".":GOSUB 3000: GOTO center_jump
	PRINT "DARTMOUTH."
	YS=1: GOTO center_jump

1250 IF RND(1)>.843*D/8 THEN PRINT "CHARGING FOUL.  DARTMOUTH LOSES BALL.":GOSUB 3000: GOTO center_jump
	PRINT "SHOOTER IS FOULED.  TWO SHOTS.":GOSUB 4000:GOSUB 3000: GOTO center_jump
